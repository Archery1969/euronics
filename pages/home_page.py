...
class HomePage:
    ...
    def cookie_button_locator(self, action='visible', fill_value=None):
    ...
    def postcode_search_locator(self, action='visible', fill_value=None):
        return perform_action(self.locators.postcode_search_button, action, fill_value)

    def contact_us_locator(self, action='visible', fill_value=None):
